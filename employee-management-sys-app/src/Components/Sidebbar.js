  ...
  return (
    <div className="col-md-3 col-lg-2 sidebar-offcanvas pl-0 sidebbar-container" id="sidebar" role="navigation" style={{ backgroundColor: "#e9ecef", height: "100vh" }}>
      ...
      <li className="nav-item mb-2 ">
          <Link to="/" className="nav-link text-secondary d-flex align-items-center" activeClassName="active">
        ...
        <li className="nav-item mb-2">
  <Link to="/update" className="nav-link text-secondary d-flex align-items-center" activeClassName="active">
