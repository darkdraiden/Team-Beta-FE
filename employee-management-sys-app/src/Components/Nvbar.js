...
//   const navbarStyle = {
//     backgroundColor:'#89CFF3 !important',
...
const Nvbar = ({ name, setIsAuthenticated }) => {
  ...
  return (
    <>
      <nav className="navbar navbar-expand-md navbar-dark bg-success mb-3 navbar-custom fixed-top" >
        <div className="container-fluid">
          <a className="navbar-brand" href="#" bold> 
            <img src={logo} alt="Logo" className="logo rounded" style={{ width: '50px', height: 'auto', marginRight: '8px' }}/>
            EmploEase
          </a>
